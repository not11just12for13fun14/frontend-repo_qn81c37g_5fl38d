      ...
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#2563eb] to-blue-400 ring-1 ring-black/10 shadow-lg" />
            <span className="text-xl font-semibold tracking-tight text-zinc-900">BlueGlass Apply</span>
          </div>
